...
namespace RigidBodySolver
{
    ...
    const double kDefaultIMURigidBodyOpticalCalTolerance = 0.24;
    ...
    public:
            ...
            , Unique( true )
        {
            ...
            IMURigidBodyOpticalCalTolerance = kDefaultIMURigidBodyOpticalCalTolerance;
        }
        ...
        double IMURigidBodyOpticalCalTolerance;
    };
}
